...
public class ProductFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
       ...
       // imageView1 = root.findViewById(R.id.sub_date);
        listview1 = (ListView) root.findViewById(R.id.listview_fragment_product);

        vendor_logo_image2 = root.findViewById(R.id.vendor_logo_img2);
    ...
    private void getData(String main_id) {
        ...
        String url = ConfigSubcategory.DATA_URL1 + main_id.trim();
    ...
    private void showJSON(final String response) {
        ...
        try {
            ...
            for (int i = 0; i < result.length(); i++) {
                ...
                String name = jo.getString(ConfigSubcategory.KEY_name);
        ...
        CustomAdapterSsubcategory adapter = new CustomAdapterSsubcategory(getContext(), arrayList1);
