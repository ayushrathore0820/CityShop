...
public class CustomAdapterSsubcategory2 extends BaseAdapter {



    //String server_url = "https://mahendrakiranastore.in/Android/addtocart.php";
    String server_url1 = "https://macona.in/city_shop_18_api/service_delete";
    Context context1;
    ViewGroup viewGroup;
    ...
    String HttpURL = "https://macona.in/city_shop_18_api/edit_vendor_service";

    public CustomAdapterSsubcategory2(Context context1, ArrayList<itemModelSubcategory> arrayList1) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final TextView name1,original_price,product_mrp,product_desc,quantity,count;
        final Button inc,dec,add_to_cart;
        ImageView image1;
        final ImageView delete,product_whatsapp_share;
